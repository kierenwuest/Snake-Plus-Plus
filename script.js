...
function drawWildCard() {
  if (tailLength > 50) {
    if (wildCardX >= W - 10) {
      wildCardX = wildCardX - 20;
    }
    if (wildCardX <= 10) {
      wildCardX = wildCardX + 20;
    }
    if (wildCardY >= H - 10) {
      wildCardY = wildCardY - 20;
    }
    if (wildCardY <= 10) {
      wildCardY = wildCardY + 20;
    }
...
function tummyAppleColumn() {
  ...
  let tummyPos = 70;
  for (let i = 0; i < tummyApples.length; i++) {
...
function tummyGrapeColumn() {
  ...
  let tummyPos = 70;
  for (let i = 0; i < tummyGrapes.length; i++) {
...
function tummyLemonColumn() {
  ...
  let tummyPos = 70;
  for (let i = 0; i < tummyLemons.length; i++) {
...
function tummyOrangeColumn() {
  ...
  let tummyPos = 70;
  for (let i = 0; i < tummyOranges.length; i++) {
...
function tummyWildColumn() {
  ...
  let tummyPos = 70;
  for (let i = 0; i < tummyWild.length; i++) {
